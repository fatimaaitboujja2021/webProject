...
public class ListeGardeService implements ListeGardeServiceInterface {
    ...
    @Autowired
    IndemniteAstreinteService indemniteAstreinteService;
...
//        String x = joursFeries(listeGarde);
    ...
    public int nombredefonc(String n,String matricule) {
        return listeGardeDao.nombredefonc(n,matricule);
    }

    public int nombredefoncgarde(String n,String matricule) {
        return listeGardeDao.nombredefoncgarde(n,matricule);
    }

    public int nombredefoncstatue(String n,String matricule) {
        return listeGardeDao.nombredefoncstatue(n,matricule);
    }
